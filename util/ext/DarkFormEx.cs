...
namespace util.ext
{
    public static class DarkFormEx
    {
        ...
        public static void dark(ListView ui)
        {
            ...
            ui.DrawColumnHeader += Ui_DrawColumnHeader;
            ui.ColumnWidthChanged += Ui_ColumnWidthChanged;
            if (ui.Columns.Count > 0)
                ui.Columns[ui.Columns.Count - 1].Width = -2;
        }

        private static void Ui_ColumnWidthChanged(object sender, ColumnWidthChangedEventArgs e)
        {
        ...
        private static void Ui_DrawColumnHeader(object sender, DrawListViewColumnHeaderEventArgs e)
        {
